...
//
//     final onTheWayResModel = onTheWayResModelFromJson(jsonString);

import 'dart:convert';

OnTheWayResModel onTheWayResModelFromJson(String str) =>
    OnTheWayResModel.fromJson(json.decode(str));

String onTheWayResModelToJson(OnTheWayResModel data) =>
    json.encode(data.toJson());

class OnTheWayResModel {
  String? message;
  int? code;
  bool? error;
  Data? data;

  OnTheWayResModel({this.message, this.code, this.error, this.data});

  factory OnTheWayResModel.fromJson(Map<String, dynamic> json) =>
      OnTheWayResModel(
