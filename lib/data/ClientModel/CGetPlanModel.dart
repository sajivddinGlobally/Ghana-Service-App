...
//
//     final cgetPlanModel = cgetPlanModelFromJson(jsonString);

import 'dart:convert';

CgetPlanModel cgetPlanModelFromJson(String str) => CgetPlanModel.fromJson(json.decode(str));

String cgetPlanModelToJson(CgetPlanModel data) => json.encode(data.toJson());
...
class CgetPlanModel {
    ...
    factory CgetPlanModel.fromJson(Map<String, dynamic> json) => CgetPlanModel(
