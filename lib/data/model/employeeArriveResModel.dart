...
//
//     final employeeArriveResModel = employeeArriveResModelFromJson(jsonString);

import 'dart:convert';

EmployeeArriveResModel employeeArriveResModelFromJson(String str) => EmployeeArriveResModel.fromJson(json.decode(str));

String employeeArriveResModelToJson(EmployeeArriveResModel data) => json.encode(data.toJson());

class EmployeeArriveResModel {
    String? message;
    int? code;
    bool? error;
    Data? data;

    EmployeeArriveResModel({
        this.message,
        this.code,
        this.error,
        this.data,
    ...
    factory EmployeeArriveResModel.fromJson(Map<String, dynamic> json) => EmployeeArriveResModel(
