...
//
//     final todayAssignRequestModel = todayAssignRequestModelFromJson(jsonString);

import 'dart:convert';

TodayAssignRequestModel todayAssignRequestModelFromJson(String str) => TodayAssignRequestModel.fromJson(json.decode(str));

String todayAssignRequestModelToJson(TodayAssignRequestModel data) => json.encode(data.toJson());
...
class TodayAssignRequestModel {
    ...
    factory TodayAssignRequestModel.fromJson(Map<String, dynamic> json) => TodayAssignRequestModel(
...
enum EmployeeId {
    THE_6_A0711433364_E540_BA73396_B
}
