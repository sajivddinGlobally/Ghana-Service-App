...
TodayPendingRequestModel todayPendingRequestModelFromJson(String str) =>
    TodayPendingRequestModel.fromJson(json.decode(str));

String todayPendingRequestModelToJson(TodayPendingRequestModel data) =>
...
class TodayPendingRequestModel {
  ...
  TodayPendingRequestModel({this.message, this.code, this.error, this.data});

  factory TodayPendingRequestModel.fromJson(Map<String, dynamic> json) =>
...
class Data {
  ...
  Data({this.total, this.totalPages, this.page, this.limit, this.list});
