...
class EmployeeDetails extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EmployeeDetails> createState() =>
...
class _EmployeeDetailsState extends ConsumerState<EmployeeDetails> {
  ...
  Widget build(BuildContext context) {
    final detailsAsync =
    ref.watch(serviceRequestDetailsProvider(widget.requestId));
    return Scaffold(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Colors.white,
                        border: Border(
                          left: BorderSide(color: AppColors.buttonText, width: 2
                              .w),
                        ),
                      ),
                      child: Column(
                            ...
                            itemBuilder: (context, index) {
                              return Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 10.h),
                                  Divider(
                                      color: AppColors.buttonText, height: 1),
                                  SizedBox(height: 10.h),
                                ],
                              );
                            },
