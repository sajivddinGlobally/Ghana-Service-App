...
GetCustomerConfirmeModel getCustomerConfirmeModelFromJson(String str) =>
    GetCustomerConfirmeModel.fromJson(json.decode(str));

String getCustomerConfirmeModelToJson(GetCustomerConfirmeModel data) =>
...
class GetCustomerConfirmeModel {
  ...
  GetCustomerConfirmeModel({this.message, this.code, this.error, this.data});

  factory GetCustomerConfirmeModel.fromJson(Map<String, dynamic> json) =>
...
class Data {
  ...
  Data({this.list, this.total, this.page, this.limit, this.totalPages});
