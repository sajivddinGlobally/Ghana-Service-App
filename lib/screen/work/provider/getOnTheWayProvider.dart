...
// final getOnTheWayProvider = FutureProvider<GetOnTheWayModel>((ref) async {
//   final service = ref.read(authServiceProvider);
//   return await service.getOnTheWayData(page: page);
// });

class GetOnTheWayNotifier extends StateNotifier<AsyncValue<GetOnTheWayModel>> {
...
//--- Provider Definition ---
final getOnTheWayProvider =
    StateNotifierProvider.autoDispose<
      GetOnTheWayNotifier,
      AsyncValue<GetOnTheWayModel>
    >((ref) {
      final authService = ref.read(authServiceProvider);
      return GetOnTheWayNotifier(authService);
    });
