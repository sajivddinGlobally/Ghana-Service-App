...
//
//     final createPlanRequestResModel = createPlanRequestResModelFromJson(jsonString);

import 'dart:convert';

CreatePlanRequestResModel createPlanRequestResModelFromJson(String str) => CreatePlanRequestResModel.fromJson(json.decode(str));

String createPlanRequestResModelToJson(CreatePlanRequestResModel data) => json.encode(data.toJson());

class CreatePlanRequestResModel {
    String? message;
    int? code;
    bool? error;
    Data? data;

    CreatePlanRequestResModel({
        this.message,
        this.code,
        this.error,
        this.data,
    ...
    factory CreatePlanRequestResModel.fromJson(Map<String, dynamic> json) => CreatePlanRequestResModel(
