...
OnTheWayResModel onTheWayResModelFromJson(String str) => OnTheWayResModel.fromJson(json.decode(str));

String onTheWayResModelToJson(OnTheWayResModel data) => json.encode(data.toJson());
...
class OnTheWayResModel {
    ...
    factory OnTheWayResModel.fromJson(Map<String, dynamic> json) => OnTheWayResModel(
