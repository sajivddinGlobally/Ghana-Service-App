...
//
//     final getCompleteRequestsModel = getCompleteRequestsModelFromJson(jsonString);

import 'dart:convert';

GetCompleteRequestsModel getCompleteRequestsModelFromJson(String str) => GetCompleteRequestsModel.fromJson(json.decode(str));

String getCompleteRequestsModelToJson(GetCompleteRequestsModel data) => json.encode(data.toJson());

class GetCompleteRequestsModel {
    String? message;
    int? code;
    bool? error;
    Data? data;

    GetCompleteRequestsModel({
        this.message,
        this.code,
        this.error,
        this.data,
    ...
    factory GetCompleteRequestsModel.fromJson(Map<String, dynamic> json) => GetCompleteRequestsModel(
