...
ServiceRequestDetailModel serviceRequestDetailModelFromJson(String str) =>
    ServiceRequestDetailModel.fromJson(json.decode(str));

String serviceRequestDetailModelToJson(ServiceRequestDetailModel data) =>
...
class ServiceRequestDetailModel {
  ...
  ServiceRequestDetailModel({this.message, this.code, this.error, this.data});
