...
CustomerConfirmArrivalResModel customerConfirmArrivalResModelFromJson(
  String str,
) => CustomerConfirmArrivalResModel.fromJson(json.decode(str));

String customerConfirmArrivalResModelToJson(
  CustomerConfirmArrivalResModel data,
...
class CustomerConfirmArrivalResModel {
  ...
  factory CustomerConfirmArrivalResModel.fromJson(Map<String, dynamic> json) =>
      CustomerConfirmArrivalResModel(
