...
class ClientGetTickettNotifier
    extends StateNotifier<AsyncValue<ClientGetTicketModel>> {
  ...
  ClientGetTickettNotifier(this.authService) : super(const AsyncLoading()) {
    clientGetTicket();
  }
  ...
  Future<void> clientGetTicket({bool isRefresh = false}) async {
    try {
      ...
      final response = await authService.clientGetTicket(page: _currentPage);
...
final clientGetTicketProvider =
    StateNotifierProvider.autoDispose<
      ClientGetTickettNotifier,
      AsyncValue<ClientGetTicketModel>
    >((ref) {
      final authService = ref.read(authServiceProvider);

      return ClientGetTickettNotifier(authService);
    });
