...
//
//     final getOnTheWayModel = getOnTheWayModelFromJson(jsonString);

import 'dart:convert';

GetOnTheWayModel getOnTheWayModelFromJson(String str) => GetOnTheWayModel.fromJson(json.decode(str));

String getOnTheWayModelToJson(GetOnTheWayModel data) => json.encode(data.toJson());

class GetOnTheWayModel {
    String? message;
    int? code;
    bool? error;
    Data? data;
    ...
    factory GetOnTheWayModel.fromJson(Map<String, dynamic> json) => GetOnTheWayModel(
