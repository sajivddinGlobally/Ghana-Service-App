...
//
//     final renewPlanModel = renewPlanModelFromJson(jsonString);

import 'dart:convert';

RenewPlanModel renewPlanModelFromJson(String str) => RenewPlanModel.fromJson(json.decode(str));

String renewPlanModelToJson(RenewPlanModel data) => json.encode(data.toJson());

class RenewPlanModel {
    String? message;
    int? code;
    bool? error;
    Data? data;
    ...
    factory RenewPlanModel.fromJson(Map<String, dynamic> json) => RenewPlanModel(
